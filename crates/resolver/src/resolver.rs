...
use proto::rr::domain::{Name, TryParseIp};
...
macro_rules! lookup_fn {
    ($p:ident, $l:ty) => {
        ...
        pub fn $p<N: TryInto<Name, Error = ProtoError>>(&self, query: N) -> ResolveResult<$l> {
...
impl Resolver {
    ...
    pub fn lookup_ip<N: TryInto<Name, Error = ProtoError> + TryParseIp>(
        &self,
        host: N,
